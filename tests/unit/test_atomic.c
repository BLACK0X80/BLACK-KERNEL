...
void test_atomic_compare_and_swap(void) {
    printf("Testing atomic_compare_and_swap...\n");
    ...
    printf("  atomic_compare_and_swap: PASSED\n");
}

void test_atomic_fetch_and_add(void) {
    printf("Testing atomic_fetch_and_add...\n");
    ...
    printf("  atomic_fetch_and_add: PASSED\n");
}

void test_atomic_store_load(void) {
    printf("Testing atomic_store and atomic_load...\n");
    ...
    printf("  atomic_store/load: PASSED\n");
}

void test_memory_barrier(void) {
    printf("Testing memory_barrier...\n");
